...
- **FR-001**: El sistema DEBE permitir registrar un cliente nuevo con nombre, email, fecha de nacimiento y su consentimiento explícito de tratamiento de datos personales para fines de fidelización (aceptado o rechazado, con fecha de captura), rechazando el registro únicamente si el email ya existe (OO-B.1, cumplimiento LOPDP). Si el consentimiento es rechazado, el cliente queda registrado solo con datos básicos, fuera del alcance de FR-005, FR-009/FR-010 y de toda campaña o cupón segmentado.
